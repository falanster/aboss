...
;
Drupal.locale = { 'pluralFormula': function ($n) { return Number(($n!=1)); }, 'strings': {"":{"Loading token browser...":"Caricamento del browser dei token...","Available tokens":"Token disponibili","Insert this token into your form":"Inserisci questo token nel form","First click a text field to insert your tokens into.":"Prima occorre cliccare sul campo di testo dove inserire i token.","Automatic alias":"Alias automatico","Not translatable":"Non traducibile","Restricted to certain languages":"Limitato ad alcune lingue","Using defaults":"Utilizza le impostazioni predefinite.","Scheduled for publishing":"Pianificato per la pubblicazione","Scheduled for unpublishing":"Pianificato per la rimozione della pubblicazione","Add file":"Aggiungi file","Cannot continue, nothing selected":"Impossibile continuare, nessuna selezione effettuata","Error getting media.":"Errore nel reperimento del media.","There is nothing in your media library. Select the Upload tab above to add a file.":"La biblioteca mediale \u00e8 vuota. Aprire la scheda Caricamento per aggiungere un file.","If you switch views, you will lose your selection.":"Se si cambia vista, la selezione verr\u00e0 azzerata."}} };;
/*!
